...
<body>
	...
	<div class="container">
		...
		<form class="form" role="form" action="saveToUpfile.php" enctype="multipart/form-data" method="post">
			...
			<input class=""  type="text" value="" name="title">
	        <input class="button " type="file" name="upfile_main" accept="image/*; capture=camera, video/*; capture=camera" multiple>
	        <input class="button " type="file" name="upfile_sub[]" accept="image/*; capture=camera, video/*; capture=camera" multiple>
			<input class=""  type="text" value="" name="message">
